...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=5b00b0&height=120&section=header"/>

<h1 align="center">Diego Silva Prado</h1>
...
<p align="left">
"Persistência e dedicação" <br><br>

👋 Olá! Sou <strong>Diego Prado</strong>, desenvolvedor focado em <strong>Backend</strong> e em evolução para <strong>Fullstack</strong>.<br><br>

🚀 <strong>Tecnologias principais:</strong> Java, Python, JavaScript e SQL.<br>
📚 <strong>Estudando atualmente:</strong> Spring Boot, Hibernate, APIs REST e iniciando em React.<br>
🎯 <strong>Objetivos:</strong> me especializar em arquitetura de APIs e desenvolvimento backend robusto.
</p>
